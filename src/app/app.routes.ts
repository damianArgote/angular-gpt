...
import { DashboardLayoutComponent } from './presentation/layouts/dashboardLayout/dashboard-layout.component';
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'text-to-audio',
        loadComponent: () =>
          import('./presentation/pages/textAudioPage/textAudioPage.component'),
        data: {
